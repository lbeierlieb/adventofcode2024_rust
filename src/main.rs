...
fn main() {
    ...
    println!(
        "4.1: {}",
        day4::task_one(read_to_string("inputs/day4").unwrap())
    );
    println!(
        "4.2: {}",
        day4::task_two(read_to_string("inputs/day4").unwrap())
    );
    println!(
        "5.1: {}",
        day5::task_one(read_to_string("inputs/day5").unwrap())
    );
    println!(
        "5.2: {}",
        day5::task_two(read_to_string("inputs/day5").unwrap())
    );
    println!(
        "6.1: {}",
        day6::task_one(read_to_string("inputs/day6").unwrap())
    );
    println!(
        "6.2: {}",
        day6::task_two(read_to_string("inputs/day6").unwrap())
    );
    println!(
        "7.1: {}",
        day7::task_one(read_to_string("inputs/day7").unwrap())
    );
    println!(
        "7.2: {}",
    ...
    println!(
        "9.1: {}",
        day9::task_one(read_to_string("inputs/day9").unwrap())
    );
    println!(
        "9.2: {}",
